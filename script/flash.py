...
if sys.argv[1] != "esp8266" and sys.argv[1] != "esp32" and sys.argv[1] != "esp32s2" and sys.argv[1] != "esp32s3" and sys.argv[1] != "esp32c3" and sys.argv[1] != "esp32lite":
  print("Supported targets are: esp8266, esp32, esp32s2, esp32s3, esp32c3 or esp32lite")
  exit(0)
