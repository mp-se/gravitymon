...
* PET Casing option
* PILL Casing option (work in progress)
...
You can of course also use an ESP8266 based iSpindle design and flash it with the Gravitymon firmware. This is the original design and 
there are many resources available on how to build this.

Cuckoo Tilt
***********

You can now also use the Cuckoo Tilt which can be found on chineese marketplaces. This is a ready to 
use device that can be flashed with the Gravitymon firmware. It has a built in battery and charging 
