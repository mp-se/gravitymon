...
class API(unittest.TestCase):
    ...
    def test_58_calibration_status(self):
    ...
    """
    def test_60_testpush_status(self):
...
"""     # Do factory reset for testing
    ...
    def test_02_status(self):
        ...
        self.a7ssertNotEqual(j["temp-format"], "")
